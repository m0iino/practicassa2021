...
Log = open("C:\\Users\\Moino\\Documents\\1er2021\\sa\\lab\\practica3\Repartidor\\log.txt", "w")
...
pedido["estado"]= 1
print("actualizar pedido",pedido)
# actualizamos el pedido del cliente 
headers = {
    'content-type' : 'application/json'
}
data = pedido
response = requests.request("POST", "http://localhost:62499/api/pedido/actualizar/",data=json.dumps(data),headers = headers)
